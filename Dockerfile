...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:11.0-alpine-preview AS build-env
ARG TARGETARCH
WORKDIR /app
...
FROM mcr.microsoft.com/dotnet/${RuntimeImageRepo}:11.0-alpine-preview AS final
