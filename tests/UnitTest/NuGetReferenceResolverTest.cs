...
public class NuGetReferenceResolverTest
{
    ...
    {
        var references = await _resolver.Resolve("WeihanLi.Common,1.0.59", ExecOptions.DefaultTargetFramework);
    ...
    {
        IReference reference = new NuGetReference("WeihanLi.Common", "1.0.59");
